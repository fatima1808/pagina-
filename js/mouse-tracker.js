...
(function() {
    ...
    function initHeader() {
        ...
        $(".canv-container").height(height);
        largeHeader = document.getElementById('header');
        largeHeader.style.height = height;
        largeHeader.style.widows = "100%";
        largeHeader.style.postiion = "relative";
        ...
        for(var x = 0; x < width; x = x + width/20) {
            for(var y = 0; y < height; y = y + height*0.2/20) {
                var px = x + Math.random()*width/20;
                var py = y + Math.random()*height*0.2/20;
